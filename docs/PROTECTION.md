...
## Protection item model roadmap

Current manager supports the safety-critical core fields. Product schema will additionally attach severity/level, alarm identity, recovery policy, feature applicability and display metadata without putting UI concerns in the detector.
